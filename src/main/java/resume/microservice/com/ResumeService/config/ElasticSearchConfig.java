...
@Configuration
@EnableJpaRepositories(basePackages = "resume.microservice.com.ResumeService.repository")
@EnableElasticsearchRepositories(basePackages = "resume.microservice.com.ResumeService.elastic")
